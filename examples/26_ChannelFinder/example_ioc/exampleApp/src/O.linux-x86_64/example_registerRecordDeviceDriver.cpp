...
static const char * const deviceSupportNames[] = {
    ...
    "devMbbiSoftCallback", "devCasterMBBIState", "devMbbiDirectSoft",
    ...
    "devSiEnviron", "devCasterSIMsg", "devSoSoft", "devSoSoftCallback",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devSiEnviron, pvar_dset_devCasterSIMsg, pvar_dset_devSoSoft,
    pvar_dset_devSoSoftCallback, pvar_dset_devSoStdio,
    pvar_dset_devSASoft, pvar_dset_devWfSoft
};
...
int example_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/ics/examples/26_ChannelFinder/example_ioc";
...
{
    iocshSetError(example_registerRecordDeviceDriver(*iocshPpdbbase));
}
