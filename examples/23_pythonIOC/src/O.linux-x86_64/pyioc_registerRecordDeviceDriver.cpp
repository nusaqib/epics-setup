...
/* Generated from ../O.Common/pyioc.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "mbbo", "mbboDirect", "permissive", "printf", "pycalc", "sel", "seq",
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devPyDevBi, *pvar_dset_devBoSoft, *pvar_dset_devBoSoftRaw,
    *pvar_dset_devBoSoftCallback, *pvar_dset_devBoGeneralTime,
    *pvar_dset_devBoDbState, *pvar_dset_devPyDevBo,
    ...
    *pvar_dset_devLiGeneralTime, *pvar_dset_devPyDevLongin,
    *pvar_dset_devLoSoft, *pvar_dset_devLoSoftCallback,
    *pvar_dset_devPyDevLongout, *pvar_dset_devLsiSoft,
    ...
    *pvar_dset_devMbbiSoftCallback, *pvar_dset_devPyDevMbbi,
    ...
    *pvar_dset_devPyDevMbbo, *pvar_dset_devMbboDirectSoft,
    ...
    *pvar_dset_devPyDevStringin, *pvar_dset_devSoSoft,
    *pvar_dset_devSoSoftCallback, *pvar_dset_devSoStdio,
    *pvar_dset_devPyDevStringout, *pvar_dset_devSASoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devPyDevAi", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
    "devPyDevAo", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devPyDevBi", "devBoSoft", "devBoSoftRaw",
    ...
    "devLoSoft", "devLoSoftCallback", "devPyDevLongout", "devLsiSoft",
    "devLsiEnviron", "devLsoSoft", "devLsoSoftCallback", "devLsoStdio",
    "devMbbiSoft", "devMbbiSoftRaw", "devMbbiSoftCallback",
    "devPyDevMbbi", "devMbbiDirectSoft", "devMbbiDirectSoftRaw",
    "devMbbiDirectSoftCallback", "devMbboSoft", "devMbboSoftRaw",
    "devMbboSoftCallback", "devPyDevMbbo", "devMbboDirectSoft",
    ...
    "devSiEnviron", "devPyDevStringin", "devSoSoft", "devSoSoftCallback",
    "devSoStdio", "devPyDevStringout", "devSASoft", "devWfSoft",
    "devPyDevWaveform"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devPyDevAi, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_devPyDevAo,
    pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_devPyDevBi, pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    ...
    pvar_dset_devPyDevStringin, pvar_dset_devSoSoft,
    pvar_dset_devSoSoftCallback, pvar_dset_devSoStdio,
    pvar_dset_devPyDevStringout, pvar_dset_devSASoft, pvar_dset_devWfSoft,
    pvar_dset_devPyDevWaveform
};
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_pydevRegister, pvar_func_rsrvRegistrar,
...
int pyioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/ics/examples";
    ...
    runRegistrarOnce(pvar_func_pydevRegister);
...
/* pyioc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pyioc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(pyioc_registerRecordDeviceDriver(*iocshPpdbbase));
}
